...
export const ProductSchema = object({
	...
	description: string()
		...
		.min(80, 'Description must be at least 225 characters'),
	price: number().required('Product price is required').min(50, 'Price must be greater than 50'),
	stock: number().required('Product stock is required').min(1, 'Price must be greater than 0'),
